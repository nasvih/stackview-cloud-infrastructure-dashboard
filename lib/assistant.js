...
const ICON = {
  /* launcher glyph: one clean speech bubble, nothing else in it */
  bubble: '<svg viewBox="0 0 20 20"><path d="M17 9.6c0 3.2-3.1 5.8-7 5.8-.86 0-1.68-.13-2.44-.36L3.4 16.4l1.1-3.05C3.56 12.32 3 11.02 3 9.6 3 6.4 6.13 3.8 10 3.8s7 2.6 7 5.8z"/></svg>',
