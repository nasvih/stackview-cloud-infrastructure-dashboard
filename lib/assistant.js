...
const ICON = {
  /* launcher glyph: the agent mark — a four-point spark, with a smaller one
     trailing it. Reads as "assistant" at 23px without any chrome around it. */
  bubble: '<svg viewBox="0 0 20 20"><path d="M8.4 2.9l1.44 3.67 3.66 1.44-3.66 1.44L8.4 13.1 6.96 9.45 3.3 8.01l3.66-1.44z"/><path d="M14.9 12.1l.72 1.83 1.83.72-1.83.72-.72 1.83-.72-1.83-1.83-.72 1.83-.72z"/></svg>',
